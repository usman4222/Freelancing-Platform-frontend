...
export default function ServicesSlider() {
  ...
  return (
    ...
    <motion.div
      ...
      className="flex flex-col items-center font-proxima overflow-hidden px-20 py-10  bg-herobackground" // Parent card
    >
      ...
      <motion.div
        className="w-full h-full grayscale hover:grayscale-0 transition-all duration-500 rounded-2xl"
        style={{
