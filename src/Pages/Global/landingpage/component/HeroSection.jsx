...
import bgImage from "../../../../assets/homepage_thumb.jpg"
...
function HeroSection() {
  return (
    <div className="h-[750px] px-20 py-10 bg-herobackground ">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
        className="flex items-center font-proxima rounded-2xl grayscale hover:grayscale-0 transition-all duration-500"
        style={{
