...
function HeroSection() {
  return (
    <motion.div
      ...
      className="bg-herobackground h-[750px] flex items-center font-proxima py-10"
    >
      <SectionWrapper className="px-10 md:px-20 w-full flex justify-between lg:flex-row md:flex-row flex-col lg:items-start md:items-start items-center rounded-b-xl">
        <motion.div
        ...
        >
          <motion.h1
            className="lg:max-w-[800px] md:max-w-[490px] lg:text-left md:text-left font-proxima font-bold text-center lg:text-[50px] text-[30px]"
            {...fadeInUp}
          ...
          <motion.p
            className="max-w-xl mt-5 lg:text-start md:text-start text-center text-muted-foreground"
            {...fadeInUp}
