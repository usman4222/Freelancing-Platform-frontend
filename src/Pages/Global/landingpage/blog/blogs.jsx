...
const blogs = [
  {
    image: "/assets/images/blogs/img1.webp",
    avatar: (
      <Avatar>
  ...
  {
    image: "/assets/images/blogs/img2.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
  ...
  {
    image: "/assets/images/blogs/img3.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
  ...
  {
    image: "/assets/images/blogs/img4.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
  ...
  {
    image: "/assets/images/blogs/img5.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
  ...
  {
    image: "/assets/images/blogs/img6.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
  ...
  {
    image: "/assets/images/blogs/img7.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
  ...
  {
    image: "/assets/images/blogs/img8.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
  ...
  {
    image: "/assets/images/blogs/img9.webp",
    avatar: (
      <Avatar>
        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
        <AvatarFallback>CN</AvatarFallback>
            ...
            {blogs.map((item, index) => (
              ...
              >
                ...
                <h1 className="sm:text-3xl text-2xl font-semibold group-hover:text-green-500 py-4 group-hover:underline duration-300">
                  <Link to={URLS.BLOG.DETAIL}>{item.title}</Link>
                </h1>
                ...
                >
                  <Link
                    to={URLS?.BLOG?.BLOG_DETAIL?.replace(":id", "some-slug")}
