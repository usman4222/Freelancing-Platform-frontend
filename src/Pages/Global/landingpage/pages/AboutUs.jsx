  ...
  return (
    <SectionWrapper className=" font-proxima px-20">
        ...
        <div className="relative">
          <div className="hidden sm:block">
            <img
              ...
              src="./assets/images/about_us/about-bg-1.webp"
              alt=""
            />
          </div>
        ...
        <div className="gap-20 lg:flex mt-20 ">
          <div>
            <img
              ...
              src="./assets/images/about_us/about5-1.webp"
              alt=""
            />
            <img
              className="w-full px-4 mt-10"
              src="./assets/images/about_us/slider62.webp"
              alt=""
            />
            <img
              className="w-full px-4 mt-10"
              src="./assets/images/about_us/h15-3-1.webp"
              alt=""
            />
            <img
              className="w-full px-4 mt-10"
      ...
      <div className=" mx-4 md:flex justify-between pt-20 gap-48">
        ...
        <div>
          <img className="" src="/assets/images/about_us/i.webp" alt="" />
        </div>
      </div>
      ...
      <div className="mt-20">
        ...
        <div className="flex items-center max-w-6xl justify-between mx-auto mt-10">
          <img className="hiden" src="/assets/images/about_us/b1-1.webp" alt="" />
          <img  src="/assets/images/about_us/b2-1.webp" alt="" />
          <img src="/assets/images/about_us/b3-1.webp" alt="" />
          <img className="hidden sm:block" src="/assets/images/about_us/b4-1.webp" alt="" />
          <img className="hidden xl:block" src="/assets/images/about_us/b5-1.webp" alt="" />
          <img className="hidden 2xl:block" src="/assets/images/about_us/b6-1.webp" alt="" />
        </div>
      </div>
    </SectionWrapper>
  );
